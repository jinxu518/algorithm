...
class KruskalsMSTII {
    ...
    public static void main(String args[]) {
        KruskalsMSTII kruskal = new KruskalsMSTII();
    ...
    private void init() {
        ...
        edges.add(new E(0, 1, 2));
        edges.add(new E(0, 3, 3));
        edges.add(new E(0, 6, 6));
        edges.add(new E(1, 2, 1));
        edges.add(new E(1, 6, 4));
        edges.add(new E(3, 5, 9));
        edges.add(new E(3, 9, 16));
        edges.add(new E(2, 4, 11));
        edges.add(new E(2, 8, 17));
        edges.add(new E(4, 7, 7));
        edges.add(new E(4, 8, 8));
        edges.add(new E(4, 6, 12));
        edges.add(new E(5, 7, 5));
        edges.add(new E(5, 9, 10));
        edges.add(new E(5, 6, 13));
        edges.add(new E(6, 8, 18));
        edges.add(new E(6, 9, 19));
        edges.add(new E(7, 9, 14));
        edges.add(new E(7, 8, 15));
        edges.add(new E(5, 4, 20));
...
class weightComparator implements Comparator<E> {
