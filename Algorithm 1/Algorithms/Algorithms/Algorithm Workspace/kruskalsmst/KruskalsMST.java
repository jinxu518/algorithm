...
public class KruskalsMST {
    public static void main(String[] args) {
        ...
        KruskalsMST graph = new KruskalsMST();	//CAREFUL: nodeCount must be correct. No error checking between nodeCount & graphEdges to see how many nodes actually exist
